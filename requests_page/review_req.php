...
<link rel="stylesheet" type="text/css" href="./styling_request.css">
...
<body class="font-monospace">
  ...
  <div class="container titlu text-center my-3">
    ...
    <h1>
      <kbd> Review requests</kbd>
    </h1>
    <div class="separator"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
      <path d="M9.5 0a.5.5 0 0 1 .5.5.5.5 0 0 0 .5.5.5.5 0 0 1 .5.5V2a.5.5 0 0 1-.5.5h-5A.5.5 0 0 1 5 2v-.5a.5.5 0 0 1 .5-.5.5.5 0 0 0 .5-.5.5.5 0 0 1 .5-.5h3Z"/>
      <path d="M3 2.5a.5.5 0 0 1 .5-.5H4a.5.5 0 0 0 0-1h-.5A1.5 1.5 0 0 0 2 2.5v12A1.5 1.5 0 0 0 3.5 16h9a1.5 1.5 0 0 0 1.5-1.5v-12A1.5 1.5 0 0 0 12.5 1H12a.5.5 0 0 0 0 1h.5a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-12Z"/>
      <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3Z"/>
    </svg></div>
    <p class="lol">
        This is a big part of being a reviewer. Take your time, read through each person's reason for requesting and accept them based on their merit, or don't!
    </p>
  ...
  if ($result->num_rows > 0) {
      echo '<div class="container my-4">
            <div class="d-flex flex-wrap">'; // Remove the card-group class
      ...
      while ($row = $result->fetch_assoc()) {
          ...
          echo '<div class="col-md-4 mb-4">
                <form action="../php_scripts/delete_request.php" method="post">
                    <input type="hidden" name="username" value="' . $username . '">
                    <input type="hidden" name="description" value="' . $description . '">
                    <div class="card border-dark" style="height: 100%;">
                        <img class="card-img rounded-circle" src="../misc/guest_picture.jpg" alt="profile_pic" style="max-height: 200px;">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-center">' . $username . '</h5>
                            <p class="card-text">'. $description .'</p>
                            <div class="d-flex justify-content-between align-items-center mt-auto">
                                <button type="submit" class="btn btn-outline-success" name="confirm_yes">Approve</button>
                                <button type="submit" class="btn btn-outline-danger" name="deny_button">Deny</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="card">
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-7">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title text-center">Username</h5>
                            <p class="card-text">Is requesting reviewer privileges.</p>
                            <div class="d-flex justify-content-between align-items-center mt-auto">
                                <button type="submit" class="btn btn-outline-success" name="confirm_yes">Approve</button>
                                <button type="submit" class="btn btn-outline-danger" name="deny_button">Deny</button>
                            </div>
