...
<link rel="stylesheet" type="text/css" href="./styling_listen.css">
...
<body class="font-monospace">
  ...
  <div class="container titlu text-center my-3">
    ...
    <p class="lol"> Discover the unexplored, rediscover the classics, and let the musical magic unfold. With "What to Listen To," the thrill of musical exploration is at your fingertips. It's not just a page; it's a personalized concert hall where every click unveils a symphony meant just for you.</p>
  ...
  if (isset($_SESSION['username'])) {
      ...
      // Select a random song that the user has not reviewed yet and has a rating over 3 stars
      $sql = "SELECT s.id, s.song_name, s.song_cover, s.author, s.album, s.release, s.description, s.song_link
            FROM songs s
            LEFT JOIN reviews r ON s.song_name = r.reviewed_song_title AND r.reviewer_name = '$userId'
            WHERE r.grade IS NULL AND s.rating > 3
            ORDER BY RAND()
            LIMIT 1";
