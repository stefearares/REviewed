...
<link rel="stylesheet" type="text/css" href="./styling_review.css">
...
<body class="font-monospace">
  ...
  <div class="container titlu text-center my-3">
    ...
    <h1>
      <kbd> The review form</kbd>
    </h1>
    <div class="separator"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-square-quote" viewBox="0 0 16 16">
      <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-2.5a2 2 0 0 0-1.6.8L8 14.333 6.1 11.8a2 2 0 0 0-1.6-.8H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2.5a1 1 0 0 1 .8.4l1.9 2.533a1 1 0 0 0 1.6 0l1.9-2.533a1 1 0 0 1 .8-.4H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
      <path d="M7.066 4.76A1.665 1.665 0 0 0 4 5.668a1.667 1.667 0 0 0 2.561 1.406c-.131.389-.375.804-.777 1.22a.417.417 0 1 0 .6.58c1.486-1.54 1.293-3.214.682-4.112zm4 0A1.665 1.665 0 0 0 8 5.668a1.667 1.667 0 0 0 2.561 1.406c-.131.389-.375.804-.777 1.22a.417.417 0 1 0 .6.58c1.486-1.54 1.293-3.214.682-4.112z"/>
    </svg></div>
    <p class="lol">
        This is why you chose to become a reviewer, the chance to add new music for the listeners to enjoy. Try to give us your unbiased opion!
    </p>
  ...
  <form class="row g-3" action="../php_scripts/song_posting.php" method="post" enctype="multipart/form-data">
  <div class="col-md-8">
    <label for="validationDefaultUsername" class="form-label">Username</label>
    <div class="input-group">
      <span class="input-group-text" id="inputGroupPrepend2">@</span>
      <input type="text" class="form-control" id="Username" name="Username" aria-describedby="inputGroupPrepend2" value="ionelpopescu01" required>
    </div>
  </div>
      <div class="col-md-4">
          <label for="Author" class="form-label">Author: </label>
          <input type="text" class="form-control" id="Author" name="Author" value="John Newman" required>
      </div>
  <div class="col-md-6">
    <label for="SongName" class="form-label">Song Name</label>
    <input type="text" class="form-control" id="SongName" name="SongName" value="Battery" required>
  </div>
  <div class="col-md-6">
    <label for="AlbumName" class="form-label">Album Name</label>
    <input type="text" class="form-control" id="AlbumName" name="AlbumName" value="Master of Puppets" required>
  </div>
  <div class="col-12">
    <label for="Summary" class="form-label">Song description summary:</label>
    <textarea class="form-control" id="Summary"  name="Summary" rows="3" required> Here you can write your short song description.</textarea>
</div>
  <div class="col-12">
      <label for="Description" class="form-label">Detailed song description</label>
      <textarea class="form-control" id="Description" name="Description" rows="3" required> Here you can write your detailed song description.</textarea>
  </div>
  <div class="col-12">
    <label for="data" class="form-label">Please select the release date!</label>
    <input type="date" class="form-control" id="data" name="data" required>
  </div>
  <div class="col-12">
    <label for="photo" class="form-label">Please select the song album cover!</label>
