...
<link rel="stylesheet" type="text/css" href="./styling_explore.css">
...
<body class="font-monospace">
  ...
  <div class="container titlu text-center my-3">
    ...
    <div class="separator"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search-heart" viewBox="0 0 16 16">
      <path d="M6.5 4.482c1.664-1.673 5.825 1.254 0 5.018-5.825-3.764-1.664-6.69 0-5.018Z"/>
      <path d="M13 6.5a6.471 6.471 0 0 1-1.258 3.844c.04.03.078.062.115.098l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1.007 1.007 0 0 1-.1-.115h.002A6.5 6.5 0 1 1 13 6.5ZM6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11Z"/>
    </svg></div>
    <p class="lol">
        Get lost in the vastness of our musical database, where the search for songs becomes a thrilling expedition, and each click is a step closer to discovering your next favorite track.    </p>
      ...
      <div class="col-md-8">
        ...
        <div class="search">
          <i class="fa fa-search"></i>
            <form action="../explore_page/explore.php" method="get">
                <input type="text" class="form-control" name="search" placeholder="Search for songs..." maxlength="70">
  ...
  if (isset($_GET['search'])) {
      ...
      $sql = "SELECT * FROM songs WHERE song_name LIKE '%$search%'";
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo '<div class="col">
                    <div class="card shadow-sm">
                        <img src="' . $row["song_cover"] . '" class="card-img-top">
                        <div class="card-body">
      ...
      echo '<div class="col">
            <div class="container my-4">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 justify-content-center">
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="../misc/login_background.jpg" class="card-img-top">
                            <div class="card-body">
                                <h4 class="card-title text-center"><kbd>Song name</kbd></h4>
                                <h6 class="card-subtitle text-center text-muted"><i>By A Famous Guy</i></h6>
                                <p class="card-text py-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="#">
                                        <button type="button" class="btn btn-outline-dark">View</button>
                                    </a>
