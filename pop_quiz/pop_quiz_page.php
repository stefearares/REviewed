...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./pop_quiz.css">
...
<div class="container titlu text-center my-3">
    ...
    <div class="separator"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
            <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2z"/>
            <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8m0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0M4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0m0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0"/>
        </svg></div>
    <p class="lol">
        Engage with fellow music enthusiasts, share your quiz triumphs, and revel in the joy of learning about the tunes that shape our world. This isn't just a quiz; it's a voyage through the heart of music, where every question unlocks a new layer of sonic discovery.    </p>
...
<script>
    (function(){
        ...
        const myQuestions = [
            {
                question: "When was Abbey Road released?",
                answers: {
                    a: "September 26, 1969",
                    b: "November 17, 1985",
                    c: "July 5, 1990"
            ...
            {
                question: "Who are the Big 4 of Metal?",
                answers: {
                    a: "Metallica, Slayer, Megadeth and Anthrax",
                    b: "Metallica, Testament, Exodus and Nirvana",
                    c: "Perl Jam, Cannibal Corpse, Janis Joplin and Anthrax"
                },
                correctAnswer: "a"
            },
            {
                question: "First Rolling Stones Album?",
                answers: {
                    a: "No Satisfaction",
                    b: "Greatest Hits",
                    c: "Born To Live",
                    d: "Not Fade Away/Little by Little"
                },
                correctAnswer: "d"
            },
            {
            ...
            {
                question: "What is the title of the first studio album by Led Zeppelin?",
                answers: {
            ...
            {
                question: "Debut album of Jimi Hendrix?",
                answers: {
                    a: "Electric Ladyland",
                    b: "Axis: Bold as Love",
